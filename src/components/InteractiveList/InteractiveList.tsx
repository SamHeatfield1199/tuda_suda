...
// Компонент для отображения интерактивного списка
export default function InteractiveList({
  ...
  return (
    <Space vertical className={styles.block}>
      <Space>
        <h2>{title}</h2>
        <Image src={icon} alt={iconAlt} width={30} height={30} />
      </Space>
      <Space className={styles.inputGroup} align='start'>
        ...
        <AppButton title='Добавить' color='lilac' onClick={onAdd} />
        {extraButton}
      </Space>
